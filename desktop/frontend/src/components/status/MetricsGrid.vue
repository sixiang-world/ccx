  ...
  <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 select-none">
    ...
    <div class="bg-glass bg-glass-hover rounded-xl p-4.5 border border-white/[0.03] flex flex-col justify-between group">
      <div class="flex items-center justify-between">
        <span class="text-[11px] font-bold tracking-wider text-slate-500 uppercase">{{ t('metrics.gatewayPort') }}</span>
    ...
    <div class="bg-glass bg-glass-hover rounded-xl p-4.5 border border-white/[0.03] flex flex-col justify-between group">
      <div class="flex items-center justify-between">
        <span class="text-[11px] font-bold tracking-wider text-slate-500 uppercase">{{ t('metrics.uptime') }}</span>
    ...
    <div class="bg-glass bg-glass-hover rounded-xl p-4.5 border border-white/[0.03] flex flex-col justify-between group">
      <div class="flex items-center justify-between">
        <span class="text-[11px] font-bold tracking-wider text-slate-500 uppercase">{{ t('metrics.channels') }}</span>
    ...
    <div class="bg-glass bg-glass-hover rounded-xl p-4.5 border border-white/[0.03] flex flex-col justify-between group">
      <div class="flex items-center justify-between">
        <span class="text-[11px] font-bold tracking-wider text-slate-500 uppercase">{{ t('metrics.version') }}</span>
