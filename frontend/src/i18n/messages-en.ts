...
export const enMessages = {
    ...
    'cockpit.overrideDuration': 'Auto-reset after idle',
    ...
    'cockpit.active': 'Active: {count}',
    'cockpit.override': 'Override: {count}',
    'cockpit.duration15min': '15 min',
    'cockpit.duration1hour': '1 hour',
    'cockpit.duration2hours': '2 hours',
    'cockpit.duration4hours': '4 hours',
    'cockpit.duration8hours': '8 hours',
    'cockpit.duration12hours': '12 hours',
    'cockpit.duration24hours': '24 hours',
    ...
    'addChannel.quickSubtitle': 'Quick add channel',
    'addChannel.testCapability': 'Test capability',

    // Navigation tabs
    'addChannel.basicInfo': 'Basic Info',
    'addChannel.authentication': 'Authentication',
    ...
    // Quick add
    'addChannel.quickInputHint': 'Paste configuration text containing Base URL and API Key, the system will parse automatically',
    'addChannel.quickInputLabel': 'Quick configuration input',
    'addChannel.quickInputPlaceholder': 'Paste configuration...',
    'addChannel.quickSubmitButton': 'Create channel',
    'addChannel.detectedType': 'Detected type: {type}',
    'addChannel.detectedName': 'Name',
    'addChannel.detectedBaseUrl': 'Base URL',
    ...
    'addChannel.headerKeyLabel': 'Header name',
    'addChannel.headerKeyPlaceholder': 'e.g., X-Custom-Header',
    'addChannel.headerValueLabel': 'Header value',
    'addChannel.headerValuePlaceholder': 'e.g., custom-value',
    'addChannel.addHeaderButton': 'Add header',

    // Stream timeout
    'addChannel.streamTimeoutTitle': 'Stream Timeout Configuration',
    'addChannel.streamTimeoutDescription': 'Configure timeout parameters for streaming responses',
    'addChannel.timeoutPresetDefault': 'Default',
    'addChannel.timeoutPresetRelaxed': 'Relaxed',
    'addChannel.timeoutPresetStrict': 'Strict',
    'addChannel.timeoutPresetCustom': 'Custom',
    'addChannel.streamFirstByteTimeoutLabel': 'First byte timeout',
    'addChannel.streamFirstByteTimeoutHint': 'Maximum time to wait for the first response content',
    'addChannel.streamChunkIntervalTimeoutLabel': 'Chunk interval timeout',
    'addChannel.streamChunkIntervalTimeoutHint': 'Maximum interval between two data chunks',
    'addChannel.streamOverallTimeoutLabel': 'Overall timeout',
    'addChannel.streamOverallTimeoutHint': 'Maximum duration for the entire streaming response',

    // Rate limiting
    'addChannel.rateLimitTitle': 'Rate Limiting Configuration',
    'addChannel.rpmLimitLabel': 'RPM limit',
    'addChannel.rpmLimitHint': 'Requests per minute limit',
    'addChannel.tpmLimitLabel': 'TPM limit',
    'addChannel.tpmLimitHint': 'Tokens per minute limit',
    'addChannel.maxConcurrencyLabel': 'Max concurrency',
    'addChannel.maxConcurrencyHint': 'Maximum number of concurrent requests',
    ...
    'addChannel.addNewMapping': 'Add New Mapping',
    ...
    'addChannel.rateLimitWindowMinutesLabel': 'Window (minutes)',
    'addChannel.rateLimitWindowMinutesPlaceholder': 'Empty = 1 min',
    'addChannel.rateLimitWindowMinutesHint': 'Sliding window duration in minutes. Example: RPM=50 + window=5 means "max 50 requests per 5 minutes".',
